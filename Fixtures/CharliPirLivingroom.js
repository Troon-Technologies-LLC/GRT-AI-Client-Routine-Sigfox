// Charli PIR Livingroom sensor fixture - Page Object Model
class CharliPirLivingroom {
  constructor(page) {
    this.page = page;
    this.apiUrl = 'https://grt-dev.grtinsight.com/api/Devices/StoreSigfoxTestData';
    this.sensorData = {
      name: "Charli PIR Livingroom",
      type: "PIR",
      location: "Livingroom",
      status: "active",
      serialNumber: "Charli PIR Livingroom",
...
module.exports = CharliPirLivingroom;
