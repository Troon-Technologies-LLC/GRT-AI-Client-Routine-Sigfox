// Charli PIR Kitchen sensor fixture - Page Object Model
class CharliPirKitchen {
  constructor(page) {
    this.page = page;
    this.apiUrl = 'https://grt-dev.grtinsight.com/api/Devices/StoreSigfoxTestData';
    this.sensorData = {
      name: "Charli PIR Kitchen",
      type: "PIR",
      location: "Kitchen",
      status: "active",
      serialNumber: "Charli PIR Kitchen",
...
module.exports = CharliPirKitchen;
