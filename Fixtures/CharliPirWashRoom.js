// Charli PIR WashRoom sensor fixture - Page Object Model
class CharliPirWashRoom {
  constructor(page) {
    this.page = page;
    this.apiUrl = 'https://grt-dev.grtinsight.com/api/Devices/StoreSigfoxTestData';
    this.sensorData = {
      name: "Charli PIR WashRoom",
      type: "PIR",
      location: "WashRoom",
      status: "active",
      serialNumber: "Charli PIR WashRoom",
...
module.exports = CharliPirWashRoom;
